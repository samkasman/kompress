...
- Document the auto-updater and signing key

### Fixed

- Staple the .app before building the DMG

### Maintenance

- Point repository references at the innernette-co org
...
- **Branching model:** adopted [GitHub Flow](https://docs.github.com/en/get-started/using-github/github-flow).
  ...
  split is gone. PROJECT_GUIDE.md hard rule #4 makes this explicit so future
...
- **Docs and tooling:** `PROJECT_GUIDE.md` documents load-bearing conventions.
