...
Project context for contributors working in this repo. Read this first to skip rediscovery.
...
- **Auto-updater payload must be the fully signed + notarized + stapled
  `.app`**, not the raw `tauri build` output.
